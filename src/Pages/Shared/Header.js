    ...
    return (
        <div className="navbar bg-[#2D2E32] text-white sticky top-0 z-50">
            ...
            <div className="navbar-end">
                <a href='https://drive.google.com/file/d/1A2B-h7ksFwGqpGZpHke5aZzzyrrnLdrH/view?usp=drive_link' target="_blank" rel="noreferrer" className='bg-[#333438] flex items-center mr-3 p-2 text-xs lg:hidden rounded hover:bg-[#2D2E32] hover:text-[#57C78E] transition-all duration-500 ease-in-out'>
                ...
                <div className='hidden lg:flex text-xs'>
                    ...
                    <a href='https://drive.google.com/file/d/1A2B-h7ksFwGqpGZpHke5aZzzyrrnLdrH/view?usp=drive_link' target="_blank" rel="noreferrer" className='bg-[#333438] flex items-center mr-5 p-2 rounded hover:bg-[#2D2E32] hover:text-[#57C78E] transition-all duration-500 ease-in-out'>
                        <FontAwesomeIcon icon={faFilePdf}></FontAwesomeIcon>
                        <p className='pl-2'>My Resume</p>
                    </a>
