...
import mitemite from "../../assets//images/mitemite.png";
                ...
                <div data-aos="fade-left" className='row-span-2 bg-[#16191E] p-10 rounded-lg w-full'>
                    <div>
                        <div className='flex items-start lg:items-center justify-between mb-3 gap-4'>
                            <div className='flex items-center'>
                                <a href='https://mitemite.vercel.app/' target="_blank" rel="noreferrer" className='mr-2 text-2xl text-white hover:text-[#57C78E] transition-all duration-300'>MiteMite</a>
                                <FontAwesomeIcon className='text-[#57C78E]' icon={faArrowUpRightFromSquare}></FontAwesomeIcon>
                            </div>
                            <div className='flex flex-wrap'>
                                <span className='px-1 text-gray-300 text-xs bg-[#4E4D53] rounded mr-2 my-1'>NextJS</span>
                                <span className='px-1 text-gray-300 text-xs bg-[#4E4D53] rounded mr-2 my-1'>ReactJS</span>
                                <span className='px-1 text-gray-300 text-xs bg-[#4E4D53] rounded mr-2 my-1'>Sanity</span>
                                <span className='px-1 text-gray-300 text-xs bg-[#4E4D53] rounded mr-2 my-1'>Tailwind CSS</span>
                            </div>
                        </div>

                        <div className='mb-3'>
                            <a className='px-2 rounded-full bg-slate-700 text-sm text-gray-400 mr-2 hover:text-[#57C78E] transition-all duration-300 ease-in-out' href='https://github.com/NafiulA/mitemite' target="_blank" rel="noreferrer"><span className='mr-2'>Client Repo
                            </span>
                                <FontAwesomeIcon icon={faLink}></FontAwesomeIcon>
                            </a>
                        </div>
                        <p className='text-sm text-gray-400 mb-10'>It's a video sharing platform where user can like and comment on each other's videos. They can also search and filter by category.</p>
                    </div>
                    <div className='w-full'>
                        <img className='rounded-lg' src={mitemite} alt="" />
                    </div>
                </div>
                <div className='h-40 flex justify-items-center items-center'>
